        ...
        <Calendar
          ...
          classNames={{
            ...
            button_next:
              "w-7 h-7 rounded-md flex items-center justify-center text-white/30 hover:text-white/70 hover:bg-white/[0.06] transition-colors border-0",
            month_caption:
              "flex h-7 w-full items-center justify-center text-xs font-medium text-white/70",
            caption_label: "text-xs font-medium text-white/70",
            weekdays: "flex",
            weekday:
              "flex-1 text-center text-[10px] text-white/20 py-1 uppercase tracking-wider font-normal",
